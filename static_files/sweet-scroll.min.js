!function(t, n) {
    ...
    function p(t) {
        ...
        if (t)
            return (null == n ? xt : n).querySelector(t)
    }
    function d(t) {
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
        if (t)
            return (null == n ? xt : n).querySelectorAll(t)
    }
    function v(t, n) {
    ...
    function S(t) {
        for (var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "y", e = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], i = Lt[n], o = t instanceof Element ? [t] : d(t), r = [], l = xt.createElement("div"), u = 0; u < o.length; u++) {
            var a = o[u];
            if (a[i] > 0 ? r.push(a) : (l.style.width = a.clientWidth + 1 + "px",
    ...
    function Z(t, n, e, i, o) {
        var r = 1.70158
          , l = 0
          , u = i;
        return 0 === n ? e : 1 === (n /= o) ? e + i : (l || (l = .3 * o),
        u < ht(i) ? (u = i,
        r = l / 4) : r = l / (2 * dt) * pt(i / u),
    ...
    function nt(t, n, e, i, o) {
        var r = 1.70158
          , l = 0
          , u = i;
        return 0 === n ? e : 2 === (n /= o / 2) ? e + i : (l || (l = o * (.3 * 1.5)),
        u < ht(i) ? (u = i,
        r = l / 4) : r = l / (2 * dt) * pt(i / u),
        n < 1 ? -.5 * (u * ct(2, 10 * (n -= 1)) * st((n * o - r) * (2 * dt) / l)) + e : u * ct(2, -10 * (n -= 1)) * st((n * o - r) * (2 * dt) / l) * .5 + i + e)
    }
    ...
    function ot(t, n, e, i, o) {
        var r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 1.70158;
        return (n /= o / 2) < 1 ? i / 2 * (n * n * (((r *= 1.525) + 1) * n - r)) + e : i / 2 * ((n -= 2) * n * (((r *= 1.525) + 1) * n + r) + 2) + e
    }
    ...
    var at = Math.cos
      ...
      , gt = Math.min
      , yt = Math.round
      , St = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
        return typeof t
    }
    : function(t) {
    ...
    var Dt = function() {
        ...
        return kt(t, [{
            ...
            value: function(t, n, e) {
                ...
                this.options = e,
                this.easing = i(e.easing) ? e.easing : At[e.easing.replace("ease", "")],
                this.progress = !0,
                setTimeout(function() {
      ...
      , Wt = function() {
        function t() {
            ...
            null == this.container ? (this.header = null,
            this.tween = null,
            this.isSSR || (/comp|inter|loaded/.test(xt.readyState) ? this.log('Not found scrollable container. => "' + e + '"') : this.log("Should be initialize later than DOMContentLoaded."))) : (this.header = p(this.options.header),
        ...
        return kt(t, [{
            ...
            value: function(t, n) {
                var e = this.container
                  ...
                  , r = o.viewport
                  , l = o.size;
                return i.top = n.verticalScroll ? vt(0, gt(l.height - r.height, i.top)) : _(e, "y"),
                i.left = n.horizontalScroll ? vt(0, gt(l.width - r.width, i.left)) : _(e, "x"),
                i
            }
        }, {
            key: "to",
                ...
                if (!this.isSSR) {
                    ...
                    this.tween.run(a.left, a.top, {
                        ...
                        complete: function() {
                            ...
                            n._options = null,
                            n._shouldCallCancelScroll ? n.hook(r, "cancelScroll") : n.hook(r, "afterScroll", a, l),
            ...
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                this.isSSR || (this.container ? (this._stopScrollListener && (this._shouldCallCancelScroll = !0),
                this.tween.stop(t)) : this.log("Not found scrollable container."))
            }
        }, {
            key: "update",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                this.container ? (this.stop(),
                this.unbindContainerClick(),
                this.unbindContainerStop(),
                this.options = c({}, this.options, t),
                this.header = p(this.options.header),
                this.bindContainerClick()) : this.isSSR || this.log("Not found scrollable container.")
            }
        }, {
            key: "destroy",
            value: function() {
                ...
                this.container = null,
                this.header = null,
                this.tween = null) : this.isSSR || this.log("Not found scrollable container.")
            }
        }, {
            key: "beforeScroll",
            value: function(t, n) {
            ...
            value: function(t) {
                ...
                if (a(t, "top") || a(t, "left"))
                    ...
                    2 === t.length ? (i.top = t[0],
                    i.left = t[1]) : (i.top = n ? t[0] : 0,
                    i.left = n ? 0 : t[0]);
                else if (l(t))
                    i.top = n ? t : 0,
                    i.left = n ? 0 : t;
            ...
            value: function() {
                ...
                t && (this._containerClickListener = this.handleContainerClick.bind(this),
            ...
            value: function() {
                var t = this.container;
                t && this._containerClickListener && (A(t, "click", this._containerClickListener),
            ...
            value: function() {
                var t = this.container;
                t && (this._stopScrollListener = this.handleStopScroll.bind(this),
            ...
            value: function() {
                var t = this.container;
                t && this._stopScrollListener && (A(t, Qt, this._stopScrollListener),
            ...
            value: function(t) {
                var n = this._options ? this._options.stopScroll : this.options.stopScroll;
            ...
            value: function(t) {
                for (var n = this.options, e = t.target; e && e !== xt; e = e.parentNode)
                    if (v(e, n.trigger)) {
                        ...
                        this._trigger = e,
                        n.horizontalScroll && n.verticalScroll ? this.to(r, n) : n.verticalScroll ? this.toTop(r, n) : n.horizontalScroll && this.toLeft(r, n)
                    }
            }
        }, {
